...
import cronner.jfaster.org.registry.exception.RegExceptionHandler;
...
public final class ZookeeperRegistryCenter implements CoordinatorRegistryCenter {
    ...
    @Override
    public void init() {
        log.debug("Cronner: zookeeper registry center init, server lists is: {}.", zkConfig.getServerLists());
    ...
    @Override
    public void closeCacheData(String cachePath) {
        try {
